...
// All icons accept an optional `size` prop (default varies by icon).
...
export function EyeIcon({ size = 16, active = false }: IconProps & { active?: boolean }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {active && (
        <>
          <path d="M12 2v3" strokeWidth="1.5" opacity="0.6" />
          <path d="M12 19v3" strokeWidth="1.5" opacity="0.6" />
          <path d="M4.22 4.22l2.12 2.12" strokeWidth="1.5" opacity="0.6" />
          <path d="M17.66 17.66l2.12 2.12" strokeWidth="1.5" opacity="0.6" />
        </>
      )}
    </svg>
  )
...
export function ChevronIcon({ size = 12, expanded = false }: IconProps & { expanded?: boolean }) {
  return (
    <svg
      ...
      className={`transition-transform ${expanded ? 'rotate-180' : ''} text-[var(--color-text-secondary)]`}
    >
      <polyline points="6 9 12 15 18 9" />
    </svg>
  )
...
export function DotIcon({ size = 14 }: IconProps) {
  return (
...
export function EditIcon({ size = 14 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V13" />
...
export function LightningIcon({ size = 12 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="shrink-0 opacity-60">
...
export function StarIcon({ size = 40 }: IconProps) {
  return (
